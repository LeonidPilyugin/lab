...
\begin{table}[!ht]
    \centering
    \caption{Задание 7}
    \resizebox{\columnwidth}{!}{\input{task7.tex}}
\end{table}
\[
...
\begin{table}[!ht]
    \centering
    \caption{АЧХ1}
    \input{achh1_primary_table.tex}
\end{table}

\begin{table}[!ht]
    \centering
    \caption{АЧХ2}
    \input{achh2_primary_table.tex}
\end{table}

\begin{table}[!ht]
    \centering
    \caption{ФЧХ1}
    \input{fchh1_primary_table.tex}
\end{table}

\begin{table}[!ht]
    \centering
    \caption{ФЧХ2}
    \input{fchh2_primary_table.tex}
\end{table}
...
\begin{figure}[ht!]
    \center{\includegraphics[width=0.8\linewidth]{../img/task13.png}}
\end{figure}
